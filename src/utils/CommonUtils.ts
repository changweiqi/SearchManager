...
class CommonUtils extends BaseClass {
    ...
    public static lock():void {
        StageUtils.getInstance().getStage().touchEnabled = StageUtils.getInstance().getStage().touchChildren = false;
    }
    ...
    public static unlock():void {
        StageUtils.getInstance().getStage().touchEnabled = StageUtils.getInstance().getStage().touchChildren = true;
    }
