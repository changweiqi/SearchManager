...
class BaseEuiView extends eui.Component implements IBaseView {
    ...
    private _myParent:egret.Sprite;
     ...
     */
    public get myParent():egret.Sprite {
    ...
    public removeFromParent():void {
        DisplayUtils.getInstance().removeFromParent(this);
    }
    ...
    public loadResource(loadComplete:Function, initComplete:Function):void {
        if (this._resources && this._resources.length > 0) {
            ResourceUtils.getInstance().loadResource(this._resources, [], loadComplete, null, this);
